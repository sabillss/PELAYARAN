function prediksiKeamanan() {
    ...
    let totalAlpha = a1 + a2 + a3 + a4 + a5 + a6 + a7 + a8 + a9 + a10 + a11 + a12;
    let hasil = (a1*z1 + a2*z2 + a3*z3 + a4*z4 + a5*z5 + a6*z6 + a7*z7 + a8*z8 + a9*z9 + a10*z10 + a11*z11 + a12*z12) / totalAlpha;
